...
{
    //Got this from Colin Gast to try out.
    ...
    public class UnhandledExceptionFilterAttribute : ExceptionFilterAttribute
    {
        ...
        {
            this.Register<UnauthorizedAccessException>(HttpStatusCode.Forbidden);
            this.Register<ArgumentException>(HttpStatusCode.BadRequest);
            this.Register<NotImplementedException>(HttpStatusCode.NotImplemented);
        }
        ...
        private static Func<Exception, HttpRequestMessage, HttpResponseMessage> DefaultHandler = (exception, request) =>
        {
            ...
            return request.CreateResponse<string>(HttpStatusCode.InternalServerError, GetContentOf(exception));
        };
        ...
        public override void OnException(HttpActionExecutedContext actionExecutedContext)
        {
            ...
            {
                // If no exception handler registered for the exception type, fall back to default handler
